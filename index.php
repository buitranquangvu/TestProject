...
<div id="body">
	...
	if(mysqli_num_rows($result_set)>0)
	{
		...
		?>
            ...
            <td align="center"><a href="javascript:edt_id('<?php echo $row[0]; ?>')"><img src="b_edit.png"  /></a></td>
            <td align="center"><a href="javascript:delete_id('<?php echo $row[0]; ?>')"><img src="b_drop.png"  /></a></td>
            </tr>
        <?php
		}
	}
